...
drop in your own data or reference the URL and build a custom visualization. Once you have a chart you want to share, you can:
...
iframe snippet does -- copy that format and use the call to th Brunel service.
