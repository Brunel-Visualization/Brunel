...
V.util_Informative.prototype.numProperty = function(key) {
...
V.util_Informative.prototype.strProperty = function(key) {
    var v = this.property(key);
    return v == null ? null : v.toString();
};

V.util_Informative.prototype.isProperty = function(key) {
    var v = this.property(key);
    return v != null && v;
};
...
V.modify_AllCombinations.prototype.matchesCurrent = function(row, dataRowOrder, dataIndex) {
    var dataRow, i;
...
V.modify_Stack.makeStackOrderedFields = function(base, keyFields, xFieldCount) {
    var i;
...
V.modify_Stack.makeStackDataOrder = function(fields, keyFieldCount, xFieldCount) {
...
V.summary_SummaryValues.prototype.makeRange = function(m, f, a, b) {
