...
public class TestAuto {
  ...
  @Test
  public void testNiceRangesNumeric() {
    assertEquals(Range.make(0.0, 10.0), Auto.makeSimpleLinearScale(0, 10));
    assertEquals(Range.make(0.0, 10.0), Auto.makeSimpleLinearScale(0.1, 10));
    assertEquals(Range.make(0.0, 10.0), Auto.makeSimpleLinearScale(1.0, 9.2));
    assertEquals(Range.make(2.0, 8.0), Auto.makeSimpleLinearScale(2.0, 8.0));
    assertEquals(Range.make(25.0, 85.0), Auto.makeSimpleLinearScale(27.0, 83.0));
  }
