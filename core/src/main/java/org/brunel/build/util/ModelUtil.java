...
public class ModelUtil {
	 ...
	 */
	public static Size getSize(VisElement vis, StyleTarget target, String tag) {
	 ...
	 */
	public static String getSymbolFromStyle(VisElement vis) {
	 ...
	 */
	public static String getLabelPosition(VisElement vis) {
	...
	public static String getLabelAlignment(VisElement vis) {
	...
	public static double getLabelPadding(VisElement vis, int defaultValue) {
	 ...
	 * @param vis the visualization to look for definitions in
	 */
	public static String getTitlePosition(VisElement vis, StyleTarget target) {
		String s = getStyle(vis, target, "label-location");
		return s == null ? "center" : s;
	}

	public static Padding getPadding(VisElement vis, StyleTarget target, int defaultSize) {
	...
	public static double getSize(VisElement vis, StyleTarget target, String tag, double defaultSize) {
	 ...
	 */
	private static String getStyle(VisElement vis, StyleTarget target, String key) {
