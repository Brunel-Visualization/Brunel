...
public class PageOutput {
    ...
    public PageOutput write() {
        ...
        if (!css.isEmpty()) {
            ...
            String[] complete = new String[lines.length + 3];
            complete[0] = "\t<style>\t\t/* Generated by Brunel style commands */";
            for (int i = 0; i < lines.length; i++) complete[2 + i] = "\t\t" + lines[i];
            complete[complete.length-1] = "\t</style>";
